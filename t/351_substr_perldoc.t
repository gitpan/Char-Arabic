...
my $color  = Char::Arabic::substr $s, 4, 5;   # black
my $middle = Char::Arabic::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Arabic::substr $s, 14;     # climebed the green tree
my $tail   = Char::Arabic::substr $s, -4;     # tree
my $z      = Char::Arabic::substr $s, -4, 2;  # tr
