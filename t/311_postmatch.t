...
$POSTMATCH
END
        print qq{ok - 4 <<END\$POSTMATCHEND $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 4 <<END\$POSTMATCHEND $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 4 <<END\$POSTMATCHEND $^X $__FILE__\n};
...
$POSTMATCH
END
        print qq{ok - 5 <<"END"\$POSTMATCHEND $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 5 <<"END"\$POSTMATCHEND $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 5 <<"END"\$POSTMATCHEND $^X $__FILE__\n};
