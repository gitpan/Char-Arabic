...
$PREMATCH
END
        print qq{ok - 4 <<END\$PREMATCHEND $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 4 <<END\$PREMATCHEND $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 4 <<END\$PREMATCHEND $^X $__FILE__\n};
...
$PREMATCH
END
        print qq{ok - 5 <<"END"\$PREMATCHEND $^X $__FILE__\n};
    }
    else {
        print qq{not ok - 5 <<"END"\$PREMATCHEND $^X $__FILE__\n};
    }
}
else {
    print qq{not ok - 5 <<"END"\$PREMATCHEND $^X $__FILE__\n};
