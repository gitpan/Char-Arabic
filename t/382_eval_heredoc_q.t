...
# eval <<'END' has eval "..."
if (eval Char::Arabic::escape <<'END') {
eval Char::Arabic::escape " if (Char::Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } "
END
...
if (eval Char::Arabic::escape <<'END') {
eval Char::Arabic::escape qq{ if (Char::Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
...
# eval <<'END' has eval q{...}
if (eval Char::Arabic::escape <<'END') {
eval Char::Arabic::escape q{ if (Char::Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
...
my $var = q{ if (Char::Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } };
if (eval Char::Arabic::escape <<'END') {
eval Char::Arabic::escape $var
END
...
# eval <<'END' has eval {...}
if (eval Char::Arabic::escape <<'END') {
eval { if (Char::Arabic::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
