...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Earabic::index($name, '::') == -1) && (Char::Earabic::index($name, "'") == -1)) {
            my $pkg;
...
# regexp of character
BEGIN { CORE::eval q{ use vars qw($your_char) } } $your_char = q{[\x00-\xFF]};
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Earabic::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Earabic::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Earabic::split(;$$$);
sub Char::Earabic::tr($$$$;$);
sub Char::Earabic::chop(@);
sub Char::Earabic::index($$;$);
sub Char::Earabic::rindex($$;$);
sub Char::Earabic::lcfirst(@);
sub Char::Earabic::lcfirst_();
sub Char::Earabic::lc(@);
sub Char::Earabic::lc_();
sub Char::Earabic::ucfirst(@);
sub Char::Earabic::ucfirst_();
sub Char::Earabic::uc(@);
sub Char::Earabic::uc_();
sub Char::Earabic::fc(@);
sub Char::Earabic::fc_();
sub Char::Earabic::ignorecase;
sub Char::Earabic::classic_character_class;
sub Char::Earabic::capture;
sub Char::Earabic::chr(;$);
sub Char::Earabic::chr_();
sub Char::Earabic::glob($);
sub Char::Earabic::glob_();

sub Char::Arabic::ord(;$);
sub Char::Arabic::ord_();
sub Char::Arabic::reverse(@);
sub Char::Arabic::getc(;*@);
sub Char::Arabic::length(;$);
sub Char::Arabic::substr($$;$$);
sub Char::Arabic::index($$;$);
sub Char::Arabic::rindex($$;$);
sub Char::Arabic::escape(;$);
...
${Char::Earabic::dot}         = qr{(?:[^\x0A])};
${Char::Earabic::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Earabic::eD}          = qr{(?:[^0-9])};
...
# ${Char::Earabic::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Earabic::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Earabic::eS}          = qr{(?:[^\s])};

${Char::Earabic::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Earabic::eH}          = qr{(?:[^\x09\x20])};
${Char::Earabic::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Earabic::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Earabic::eN}          = qr{(?:[^\x0A])};
${Char::Earabic::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Earabic::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Earabic::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Earabic::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Earabic::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Earabic::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Earabic::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Earabic::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Earabic::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Earabic::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Earabic::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Earabic::not_space}   = qr{(?:[^\s\x0B])};
${Char::Earabic::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Earabic::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Earabic::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Earabic::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Earabic::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Earabic::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Earabic::foo" used only once: possible typo at here.
${Char::Earabic::dot}         = ${Char::Earabic::dot};
${Char::Earabic::dot_s}       = ${Char::Earabic::dot_s};
${Char::Earabic::eD}          = ${Char::Earabic::eD};
${Char::Earabic::eS}          = ${Char::Earabic::eS};
${Char::Earabic::eW}          = ${Char::Earabic::eW};
${Char::Earabic::eH}          = ${Char::Earabic::eH};
${Char::Earabic::eV}          = ${Char::Earabic::eV};
${Char::Earabic::eR}          = ${Char::Earabic::eR};
${Char::Earabic::eN}          = ${Char::Earabic::eN};
${Char::Earabic::not_alnum}   = ${Char::Earabic::not_alnum};
${Char::Earabic::not_alpha}   = ${Char::Earabic::not_alpha};
${Char::Earabic::not_ascii}   = ${Char::Earabic::not_ascii};
${Char::Earabic::not_blank}   = ${Char::Earabic::not_blank};
${Char::Earabic::not_cntrl}   = ${Char::Earabic::not_cntrl};
${Char::Earabic::not_digit}   = ${Char::Earabic::not_digit};
${Char::Earabic::not_graph}   = ${Char::Earabic::not_graph};
${Char::Earabic::not_lower}   = ${Char::Earabic::not_lower};
${Char::Earabic::not_lower_i} = ${Char::Earabic::not_lower_i};
${Char::Earabic::not_print}   = ${Char::Earabic::not_print};
${Char::Earabic::not_punct}   = ${Char::Earabic::not_punct};
${Char::Earabic::not_space}   = ${Char::Earabic::not_space};
${Char::Earabic::not_upper}   = ${Char::Earabic::not_upper};
${Char::Earabic::not_upper_i} = ${Char::Earabic::not_upper_i};
${Char::Earabic::not_word}    = ${Char::Earabic::not_word};
${Char::Earabic::not_xdigit}  = ${Char::Earabic::not_xdigit};
${Char::Earabic::eb}          = ${Char::Earabic::eb};
${Char::Earabic::eB}          = ${Char::Earabic::eB};
...
#
# Arabic lower case first with parameter
#
sub Char::Earabic::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Earabic::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Earabic::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Earabic::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Arabic lower case first without parameter
#
sub Char::Earabic::lcfirst_() {
    return Char::Earabic::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Arabic lower case with parameter
#
sub Char::Earabic::lc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Earabic::lc_();
    }
}

#
# Arabic lower case without parameter
#
sub Char::Earabic::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Arabic upper case first with parameter
#
sub Char::Earabic::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Earabic::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Earabic::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Earabic::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Arabic upper case first without parameter
#
sub Char::Earabic::ucfirst_() {
    return Char::Earabic::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Arabic upper case with parameter
#
sub Char::Earabic::uc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Earabic::uc_();
    }
}

#
# Arabic upper case without parameter
#
sub Char::Earabic::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Arabic fold case with parameter
#
sub Char::Earabic::fc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Earabic::fc_();
    }
}

#
# Arabic fold case without parameter
#
sub Char::Earabic::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Arabic regexp ignore case modifier
#
sub Char::Earabic::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Earabic::uc($char[$i]);
                my $fc = Char::Earabic::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Arabic characters per length
#
...
#
# Arabic open character list for tr
#
sub _charlist_tr {
...
#
# Arabic open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Earabic::not_lower_i}',
                '[:^upper:]'  => '${Char::Earabic::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Earabic::not_alnum}',
                '[:^alpha:]'  => '${Char::Earabic::not_alpha}',
                '[:^ascii:]'  => '${Char::Earabic::not_ascii}',
                '[:^blank:]'  => '${Char::Earabic::not_blank}',
                '[:^cntrl:]'  => '${Char::Earabic::not_cntrl}',
                '[:^digit:]'  => '${Char::Earabic::not_digit}',
                '[:^graph:]'  => '${Char::Earabic::not_graph}',
                '[:^lower:]'  => '${Char::Earabic::not_lower}',
                '[:^print:]'  => '${Char::Earabic::not_print}',
                '[:^punct:]'  => '${Char::Earabic::not_punct}',
                '[:^space:]'  => '${Char::Earabic::not_space}',
                '[:^upper:]'  => '${Char::Earabic::not_upper}',
                '[:^word:]'   => '${Char::Earabic::not_word}',
                '[:^xdigit:]' => '${Char::Earabic::not_xdigit}',
...
#
# Arabic hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Arabic open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Earabic::uc($char);
                        my $fc = Char::Earabic::fc($char);
                        if ($uc eq $fc) {
...
#
# Arabic order to character (with parameter)
#
sub Char::Earabic::chr(;$) {
...
#
# Arabic order to character (without parameter)
#
sub Char::Earabic::chr_() {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Earabic::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Earabic::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Earabic::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Earabic::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Char::Earabic::POSTMATCH {
    return $';
}

#
# Arabic character to order (with parameter)
#
sub Char::Arabic::ord(;$) {
...
#
# Arabic character to order (without parameter)
#
sub Char::Arabic::ord_() {
...
#
# Arabic getc (with parameter, without parameter)
#
sub Char::Arabic::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Char::Arabic::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Earabic::dot_s} \z/oxms) {
...
#
# Arabic index by character
#
sub Char::Arabic::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Char::Earabic::index($_[0], $_[1], CORE::length(Char::Arabic::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Earabic::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Arabic::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Arabic rindex by character
#
sub Char::Arabic::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Earabic::rindex($_[0], $_[1], CORE::length(Char::Arabic::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Earabic::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Arabic::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Arabic::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Arabic::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Arabic::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Earabic::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Earabic::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Earabic::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Earabic::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Earabic::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Earabic::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Earabic::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Earabic::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Earabic::glob';
    }
...
# subroutines of package Char::Earabic
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Arabic::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Arabic::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Arabic::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Earabic::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Arabic::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Arabic::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Earabic::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Arabic::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Arabic::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Earabic::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Earabic::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Earabic::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Earabic::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Earabic::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Earabic::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Earabic::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Earabic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Earabic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Earabic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Earabic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Earabic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Earabic::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Earabic::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Earabic::PREMATCH()]}
            ...
            $e_string .= q{Char::Earabic::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Earabic::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Earabic::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Earabic::POSTMATCH()]}
            ...
            $e_string .= q{Char::Earabic::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Earabic
        ...
        elsif ($string =~ /\G \b Char::Arabic::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Arabic::eval \b                                /oxgc) { $e_string .= 'eval Char::Arabic::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Earabic::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Arabic::index \b                               /oxgc) { $e_string .= 'Char::Arabic::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Earabic::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Arabic::rindex \b                              /oxgc) { $e_string .= 'Char::Arabic::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Earabic::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Earabic::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Earabic::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Earabic::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Earabic::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Earabic::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Earabic::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Earabic::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Earabic::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Earabic::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Earabic::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Earabic::dot_s}';
        }
        else {
            return '${Char::Earabic::dot}';
        }
    }
    else {
        return Char::Earabic::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Earabic::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Earabic::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Earabic::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Earabic::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Earabic::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Earabic::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Earabic::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Earabic::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Earabic::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Earabic::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Earabic::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Earabic::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Earabic::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Earabic::uc($char[$i]) ne Char::Earabic::fc($char[$i]))) {
            if (CORE::length(Char::Earabic::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Earabic::uc($char[$i])       . Char::Earabic::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Earabic::uc($char[$i]) . '|' . Char::Earabic::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Earabic::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Earabic::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Earabic::ignorecase(Char::Earabic::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Earabic::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Earabic::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Earabic::ignorecase(Char::Earabic::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Earabic::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Earabic::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Earabic::ignorecase(Char::Earabic::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Earabic::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Arabic::re_t=%s; while($Char::Arabic::re_t =~ %s){%s local $^W=0; local $Char::Arabic::re_r=%s; %s$Char::Arabic::re_t="$`$Char::Arabic::re_r$'"; pos($Char::Arabic::re_t)=length "$`$Char::Arabic::re_r"; } return $Char::Arabic::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Arabic::re_r=CORE::eval $Char::Arabic::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Arabic::re_r=%s; %s"%s$Char::Arabic::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Arabic::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Arabic::re_r=%s; %s%s="$`$Char::Arabic::re_r$'"; pos(%s)=length "$`$Char::Arabic::re_r"; $Char::Arabic::re_n++} return %s$Char::Arabic::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Arabic::re_r=%s; %s%s="%s$Char::Arabic::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Arabic::re_r=%s; %s%s="%s$Char::Arabic::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Arabic::re_r=CORE::eval $Char::Arabic::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Earabic::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Earabic::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Earabic::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Earabic;
    ...
    Char::Earabic::lc(...);
    Char::Earabic::lc_;
    Char::Earabic::lcfirst(...);
    Char::Earabic::lcfirst_;
    Char::Earabic::uc(...);
    Char::Earabic::uc_;
    Char::Earabic::ucfirst(...);
    Char::Earabic::ucfirst_;
    Char::Earabic::fc(...);
    Char::Earabic::fc_;
    Char::Earabic::ignorecase(...);
    Char::Earabic::capture(...);
    Char::Earabic::chr(...);
    Char::Earabic::chr_;
    Char::Earabic::glob(...);
    Char::Earabic::glob_;

  # "no Char::Earabic;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Arabic software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Arabic software and not
...
This Char::Earabic module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Earabic::split(/pattern/,$string,$limit);
  @split = Char::Earabic::split(/pattern/,$string);
  @split = Char::Earabic::split(/pattern/);
  @split = Char::Earabic::split('',$string,$limit);
  @split = Char::Earabic::split('',$string);
  @split = Char::Earabic::split('');
  @split = Char::Earabic::split();
  @split = Char::Earabic::split;
  ...
  at all, Char::Earabic::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Earabic::split(//,  $word);
  @fields = Char::Earabic::split(/:/, $line);
  @words  = Char::Earabic::split(" ", $paragraph);
  @lines  = Char::Earabic::split(/^/, $buffer);
  ...
  print join(":" => Char::Earabic::split(/ */, "hi there"));
  ...
  Char::Earabic::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Earabic::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Earabic::split with no arguments does. Thus,
  Char::Earabic::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Earabic::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Earabic::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Earabic::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Earabic::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Earabic::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Earabic::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Earabic::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Arabic string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Arabic string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Char::Earabic::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Earabic::chop(@list);
  $chop = Char::Earabic::chop();
  $chop = Char::Earabic::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Earabic::chop subroutine is used primary to remove the newline
  ...
  since Char::Earabic::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Earabic::chop a literal, only a variable. If you Char::Earabic::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Earabic::chop(@lines);

  You can Char::Earabic::chop anything that is an lvalue, including an assignment:

  Char::Earabic::chop($cwd = `pwd`);
  Char::Earabic::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Earabic::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Earabic::chop returns the character
  ...
  In the most general case, Char::Earabic::chop can be expressed using substr:

  $last_code = Char::Earabic::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Earabic::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Earabic::chop;
...
=item Index string
  ...
  $byte_pos = Char::Earabic::index($string,$substr,$byte_offset);
  $byte_pos = Char::Earabic::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Earabic::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Earabic::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Earabic::rindex($string,$substr);

  This subroutine works just like Char::Earabic::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Earabic::index).
  ...
  while (($byte_pos = Char::Arabic::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Earabic::lc($string);
  $lc = Char::Earabic::lc_;

  This subroutine returns a lowercased version of Arabic $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Char::Earabic::fc subroutine for case-insensitive comparisons via Char::Arabic
  software.

=item Lower case first character of string

  $lcfirst = Char::Earabic::lcfirst($string);
  $lcfirst = Char::Earabic::lcfirst_;

  This subroutine returns a version of Arabic $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item Upper case string

  $uc = Char::Earabic::uc($string);
  $uc = Char::Earabic::uc_;

  This subroutine returns an uppercased version of Arabic $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Char::Earabic::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Earabic::ucfirst($string);
  $ucfirst = Char::Earabic::ucfirst_;
  ...
  $titlecase = Char::Earabic::ucfirst(substr($word,0,1)) . Char::Earabic::lc(substr($word,1));
  ...
  $do_not_use = Char::Earabic::ucfirst(Char::Earabic::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Earabic::fc($string);
  $fc = Char::Earabic::fc_;

  New to Char::Arabic software, this subroutine returns the full Unicode-like casefold of
  Arabic $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Char::Earabic::fc($a) eq Char::Earabic::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Arabic software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Earabic::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Earabic::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Earabic::chr($code);
  $chr = Char::Earabic::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Earabic::chr(65) is "A" in either
  ASCII or Arabic, not Unicode. For the reverse of Char::Earabic::chr, use Char::Arabic::ord.

=item Filename expansion (globbing)

  @glob = Char::Earabic::glob($string);
  @glob = Char::Earabic::glob_;
  ...
  The Char::Earabic::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Earabic::glob('"*e f*"');
  @spacies = Char::Earabic::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Earabic::glob("'*${var}e f*'");
  @spacies = Char::Earabic::glob(qq("*${var}e f*"));
