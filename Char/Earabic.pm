...
$VERSION = sprintf '%d.%02d', q$Revision: 0.94 $ =~ /(\d+)/xmsg;
...
This module is a run-time routines of the Char/Arabic.pm.
Because the Char/Arabic.pm automatically uses this module, you need not use directly.
