...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Earabic::function_ord     = 'Char::Arabic::ord'     if /\A ord \z/oxms;
                    $Char::Earabic::function_ord_    = 'Char::Arabic::ord_'    if /\A ord \z/oxms;
                    $Char::Earabic::function_reverse = 'Char::Arabic::reverse' if /\A reverse \z/oxms;
                    $Char::Earabic::function_getc    = 'Char::Arabic::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Arabic::escape();
...
=head1 Calling 'Char::Earabic::ignorecase()' (Char::Arabic software provides)

Char::Arabic software applies calling 'Char::Earabic::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Arabic software provides)

Char::Arabic software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Arabic software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Arabic software provides)

Char::Arabic software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Arabic software and
